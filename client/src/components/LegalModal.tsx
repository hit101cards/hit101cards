...
const PRIVACY: Record<string, Doc> = {
  ja: {
    ...
    sections: [
      ...
      { title: '7. お問い合わせ', body: '本ポリシーに関するお問い合わせは以下までお願いします。', contactEmail: 'hit101cards@gmail.com' },
  ...
  en: {
    ...
    sections: [
      ...
      { title: '7. Contact', body: 'For inquiries about this policy, please contact us at:', contactEmail: 'hit101cards@gmail.com' },
...
const TERMS: Record<string, Doc> = {
  ja: {
    ...
    sections: [
      ...
      { title: '9. お問い合わせ', contactEmail: 'hit101cards@gmail.com' },
    ],
  },
  en: {
    ...
    sections: [
      ...
      { title: '9. Contact', contactEmail: 'hit101cards@gmail.com' },
    ],
  },
};
